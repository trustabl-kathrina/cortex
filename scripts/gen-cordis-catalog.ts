...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@cortex/typert-generator'
import type { CordisCatalogPolicy } from '@cortex/typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@cortex/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  cortexHomePath: 'not a service: boot-provided root accessor function (typeof cortexHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
 ...
 * scan reads EVERY `declare module '@cortex/cordis'` Events merge under
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CortexEnvironment: 'subprocess.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  AtlassianSettings: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  AtlassianStatus: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  ProbeRequest: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  ProbeResult: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  OpenRequest: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  OpenResult: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  AckResult: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  PinRequest: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  ListPullRequestsRequest: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  ListPullRequestsResult: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  PostFindingRequest: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  PostFindingResult: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  DismissFindingRequest: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  CancelReviewRequest: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  DiffContextRequest: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  DiffContextResult: 'Atlassian panel contract is owned by packages/atlassian/atlassian/README.md',
  ...
  LocaleDict: 'service-local dictionary fields are owned by packages/client/locale/src/client/index.ts',
  ThemeTokens: 'service-local token dictionary is owned by packages/client/ui-theme/src/index.ts',
  Translate: 'service-local bound translator is owned by packages/client/ui-slots/src/index.ts',
  WebUpgradeRoute:
 ...
 * runtime API module, plus, per mapped subsystems page, the updated document
 * with the injected region. Fail-loud partition checks live here: an unmapped
 * service/event scope, a mapping whose page file does not exist, a curated
 * entry whose key/scope the projection no longer discovers, a declared Context
 * key or Events member the projection cannot see without a named walk
...
export function computeOutputs(): [string, string][] {
  ...
  for (const page of pages) {
    ...
    try {
      ...
      // The page must exist before a region can be injected; the generator
      // names the miss instead of creating a page skeleton.
