 ...
 *
 * @module cortex-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@cortex/llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@cortex/llm'
import { attributionHeaders } from '@cortex/llm'
 ...
 * on the length the server claims — the same two-stage shape `cortex-web-fetch`
